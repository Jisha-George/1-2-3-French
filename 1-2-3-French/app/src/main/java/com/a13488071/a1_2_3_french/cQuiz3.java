...
public class cQuiz3 extends AppCompatActivity {
        ...
        keys = shuffleArray(keys);
                ...
                bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            case R.id.learn_id:
                                Intent intent = new Intent(cQuiz3.this, MainActivity.class);
                                startActivity(intent);
                                break;

                            case R.id.quiz_id:
                                Intent intent1 = new Intent(cQuiz3.this, QuizPage.class);
                                startActivity(intent1);
                                break;

                            case R.id.stats_id:
                                Intent intent2 = new Intent(cQuiz3.this, StatsPage.class);
            ...
            private void doValidate() {
                ...
                if (editText.getText().toString().equals(answer)) {
                    ...
                    Toast.makeText(cQuiz3.this, "Wrong", Toast.LENGTH_SHORT).show();
                    editText.setText("");
                }
